...
-  <span style="color:white">![rsquared](https://latex.codecogs.com/svg.image?r^{2})</span> is the coeffiecient of determination, which is a measure of how well the model fits the data. It describes the proportion of the variance in the dependent variable that is predictable from the independent variables.
